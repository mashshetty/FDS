...
function Admin() {
  ...
  const sub = async (e) => {
    ...
    const res = await axios.post("http://localhost:5001/foodlist", {
      name: name,
      price: price,
      image: image,
      shopname: sel,
  ...
  {
  const res = await axios.post("http://localhost:5001/lotus", {
    name: name,
    price: price,
    image: image,
    shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/shreesai", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/shambavan", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/scs", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/amra", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/maruthi", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/veg", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/kushm", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
...
{
const res = await axios.post("http://localhost:5001/laxmi", {
  name: name,
  price: price,
  image: image,
  shopname: sel,
  ...
  const res = await axios.post("http://localhost:5001/mixdata", {
    name: name,
    price: price,
    image: image,
    shopname: sel,
...
console.log("selected value is...",sel)
  ...
  const addshop = async (e) => {
    ...
    const res = await axios.post("http://localhost:5001/addshop", {
      shopname: shopname,
      address: address,
      image: simage,
      oc: oc,
  ...
  const chh =()=>{
    ...
    const up = axios.put(`http://localhost:5001/onof/631b87bdb81a84b7fd5693d2`, {
      on: val,
