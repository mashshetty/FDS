...
function ModifySuj() {
  ...
  useEffect(() => {
    const f = async () =>
      await axios.get("http://localhost:5001/getshops").then((response) => {
    ...
    if (ssel.toUpperCase() === "LOTUS") {
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/lotus/${e.target.id}`
        );
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/shreesai/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/shambavan/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/scs/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/amra/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/maruthi/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/veg/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/kushm/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/laxmi/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
      ...
      try {
        const deldata = await axios.delete(
          `http://localhost:5001/mixdata/${e.target.id}`
        );
        const newdata = alldata.filter((item) => item._id !== e.target.id);
        setalldata(newdata);
      } catch (err) {
  ...
  const sub = (e) => {
    ...
    if (ssel.toUpperCase() === "LOTUS") {
      const up = axios.put(`http://localhost:5001/lotus/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/shreesai/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/shambavan/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/scs/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/amra/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/maruthi/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/veg/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/kushm/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/laxmi/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
      ...
      const up = axios.put(`http://localhost:5001/mixdata/${upid}`, {
        name: name,
        price: price,
        image: image,
        shopname: sel,
